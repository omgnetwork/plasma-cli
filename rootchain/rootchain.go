...
// ChallengeStandardExit is a paid mutator transaction binding the contract method 0xc168e4ed.
//
// Solidity: function challengeStandardExit(_outputId uint192, _challengeTx bytes, _inputIndex uint256, _challengeTxSig bytes) returns()
func (_Rootchain *RootchainTransactor) ChallengeStandardExit(opts *bind.TransactOpts, _outputId *big.Int, _challengeTx []byte, _inputIndex *big.Int, _challengeTxSig []byte) (*types.Transaction, error) {
...
//
// Solidity: function challengeStandardExit(_outputId uint192, _challengeTx bytes, _inputIndex uint256, _challengeTxSig bytes) returns()
func (_Rootchain *RootchainSession) ChallengeStandardExit(_outputId *big.Int, _challengeTx []byte, _inputIndex *big.Int, _challengeTxSig []byte) (*types.Transaction, error) {
...
//
// Solidity: function challengeStandardExit(_outputId uint192, _challengeTx bytes, _inputIndex uint256, _challengeTxSig bytes) returns()
func (_Rootchain *RootchainTransactorSession) ChallengeStandardExit(_outputId *big.Int, _challengeTx []byte, _inputIndex *big.Int, _challengeTxSig []byte) (*types.Transaction, error) {
	return _Rootchain.Contract.ChallengeStandardExit(&_Rootchain.TransactOpts, _outputId, _challengeTx, _inputIndex, _challengeTxSig)
}
